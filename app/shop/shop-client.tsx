...
function ShopCatalogContent({ initialProducts }: ShopClientProps) {
  ...
  // If initialProducts changes, sync it (e.g. if loaded dynamically/hydrated)
  useEffect(() => {
      ...
      <main className="flex-1 py-12 lg:py-20">
        <div className="container mx-auto px-4 lg:px-8 max-w-6xl">
          <Suspense fallback={
            ...
            <ShopCatalogContent initialProducts={initialProducts} />
          </Suspense>
        </div>
      </main>
